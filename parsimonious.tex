...
\cite{stevanato2013high} and \cite{saccomani2009molecular}.
...
First, the 175 SNP available for the analysis were ranked based on their
importance/relevance for predicting the trait under study.
In the second his is an iterative step. we progressively reduced the predictors set, 

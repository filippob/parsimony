...
One exciting application of molecular breeding are genomic predictions
(\cite{meuwissen2001prediction}): something on genomic predictions in
general. The recent publication of the reference genome for \emph{Beta
vulgaris} genome \cite{dohm2013genome} facilitated molecular breeding
also in this crop species. Genomic predictions in sugar beet already
...
Figure 1: Accuracy as a function of the number of predictors, BOSS vs GWAS

Table 1(2?): TER, FPR, FNR for the first 30/35 SNPs + average for the
...
with ROC curve? Maybe in discussion? Wait for results to be ready

Plot AUC vs \# predictors? No, use AUC as result in the text (e.g.

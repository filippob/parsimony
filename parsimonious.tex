...
time the least relevant predictor.
...
good predictive ability was related to the high heritability ($h^2=783$)
...
\subsection{Linklage disequilibrium and probability of assignment}
